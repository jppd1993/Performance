  ...
  return (
    <div className="container mt-5">
      ...
      <div className="list-group">
        ...
        {/* ลิงก์ไปยังหน้าตรวจสอบข้อมูลเครื่องคัด */}
        <Link href="https://performance-git-master-jatuphong-s-projects.vercel.app/gradingCheck" legacyBehavior>
          <a className="list-group-item list-group-item-action">ตรวจสอบข้อมูลการคัด</a>
        </Link>
